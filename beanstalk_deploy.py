...
BUCKET_KEY = os.getenv('APPLICATION_NAME') + '/' + VERSION_LABEL + '-test-0.0.1-SNAPSHOT.jar'

def upload_to_s3(artifact):
    """
    Uploads an artifact to Amazon S3
    """
    print("Uploads an artifact to Amazon S3\n")
...
def main():
    ...
    if not upload_to_s3('target/test-0.0.1-SNAPSHOT.jar'):
        sys.exit(1)
